...
class Message(Object, Update):
    ...
    Parameters:
        ...
        service (``str``, *optional*):
            ...
            migrate_to_chat.id, migrate_from_chat.id, pinned_message, game_high_score, voice_chat_started,
        ...
        migrate_to_chat.id (``int``, *optional*):
        ...
        migrate_from_chat.id (``int``, *optional*):
    ...
    def __init__(
        ...
        *,
        ...
        migrate_to_chat.id: int = None,
        migrate_from_chat.id: int = None,
        ...
        self.media_group.id = media_group.id
        ...
        self.migrate_to_chat.id = migrate_to_chat.id
        self.migrate_from_chat.id = migrate_from_chat.id
    ...
    async def _parse(
        ...
        from.id = utils.get_raw_peer.id(message.from.id)
        peer.id = utils.get_raw_peer.id(message.peer.id)
        user.id = from.id or peer.id

        if isinstance(message.from.id, raw.types.PeerUser) and isinstance(message.peer.id, raw.types.PeerUser):
            if from.id not in users or peer.id not in users:
                try:
                    r = await client.send(
                        raw.functions.users.GetUsers(
                            id=[
                                await client.resolve_peer(from.id),
                                await client.resolve_peer(peer.id)
                            ]
                        )
                    )
        ...
        if isinstance(message, raw.types.MessageService):
            ...
            migrate_to_chat.id = None
            migrate_from_chat.id = None
            ...
            if isinstance(action, raw.types.MessageActionChatAddUser):
                ...
                new_chat_members = [types.User._parse(client, users[utils.get_raw_peer.id(message.from.id)])]
                service_type = "new_chat_members"
            elif isinstance(action, raw.types.MessageActionChatDeleteUser):
                left_chat_member = types.User._parse(client, users[action.user.id])
                ...
                migrate_to_chat.id = action.channel.id
                service_type = "migrate_to_chat.id"
            elif isinstance(action, raw.types.MessageActionChannelMigrateFrom):
                migrate_from_chat.id = action.chat.id
                service_type = "migrate_from_chat.id"
            ...
            from_user = types.User._parse(client, users.get(user.id, None))
            ...
            parsed_message = Message(
                ...
                migrate_to_chat.id=utils.get_channel.id(migrate_to_chat.id) if migrate_to_chat.id else None,
                migrate_from_chat.id=-migrate_from_chat.id if migrate_from_chat.id else None,
            ...
            if isinstance(action, raw.types.MessageActionPinMessage):
                try:
                    parsed_message.pinned_message = await client.get_messages(
                        ...
                        reply_to_message.ids=message.id,
                        replies=0
                    )
        ...
        if isinstance(message, raw.types.Message):
            ...
            if forward_header:
                ...
                if forward_header.from.id:
                    raw_peer.id = utils.get_raw_peer.id(forward_header.from.id)
                    peer.id = utils.get_peer.id(forward_header.from.id)

                    if peer.id > 0:
                        forward_from = types.User._parse(client, users[raw_peer.id])
                    else:
                        forward_from_chat = types.Chat._parse_channel_chat(client, chats[raw_peer.id])
            ...
            parsed_message = Message(
                ...
                media_group.id=message.grouped.id,
                photo=photo,
                location=location,
                contact=contact,
                venue=venue,
                ...
                dice=dice,
                views=message.views,
                via_bot=types.User._parse(client, users.get(message.via_bot.id, None)),
    ...
    def link(self) -> str:
        if self.chat.type in ("group", "supergroup", "channel") and self.chat.username:
            return f"https://t.me/{self.chat.username}/{self.message.id}"
        else:
            return f"https://t.me/c/{utils.get_channel.id(self.chat.id)}/{self.message.id}"
    ...
    async def reply_text(
        ...
        .. code-block:: python
            ...
            client.send_message(
                chat.id=message.chat.id,
                text="hello",
                reply_to_message.id=message.message.id
            )
        ...
        Parameters:
            ...
            quote (``bool``, *optional*):
                ...
                If *reply_to_message.id* is passed, this parameter will be ignored.
            ...
            reply_to_message.id (``int``, *optional*):
        ...
        if reply_to_message.id is None and quote:
            reply_to_message.id = self.message.id
        ...
        return await self._client.send_message(
            ...
            reply_to_message.id=reply_to_message.id,
            reply_markup=reply_markup
        )
    ...
    async def reply_animation(
        ...
        Parameters:
            animation (``str``):
                Animation to send.
                Pass a file.id as string to send an animation that exists on the Telegram servers,
    ...
    async def reply_audio(
        ...
        Parameters:
            audio (``str``):
                Audio file to send.
                Pass a file.id as string to send an audio file that exists on the Telegram servers,
    ...
    async def reply_cached_media(
        ...
        Example:
            .. code-block:: python
                ...
                message.reply_cached_media(file.id)

        Parameters:
            file.id (``str``):
                Media to send.
                Pass a file.id as string to send a media that exists on the Telegram servers.
    ...
    async def reply_document(
        ...
        Parameters:
            document (``str``):
                File to send.
                Pass a file.id as string to send a file that exists on the Telegram servers,
    ...
    async def reply_inline_bot_result(
        ...
        Example:
            .. code-block:: python
                ...
                message.reply_inline_bot_result(query.id, result.id)
        ...
        Parameters:
            ...
            reply_to_message.id (``bool``, *optional*):
                If the message is a reply, ID of the original message.
    ...
    async def reply_photo(
        ...
        Parameters:
            photo (``str``):
                Photo to send.
                Pass a file.id as string to send a photo that exists on the Telegram servers,
    ...
    async def reply_poll(
        ...
        Parameters:
            ...
            correct_option.id (``int``, *optional*):
        ...
        return await self._client.send_poll(
            ...
            type=type,
            correct_option.id=correct_option.id,
            disable_notification=disable_notification,
            reply_to_message.id=reply_to_message.id,
            schedule_date=schedule_date,
            reply_markup=reply_markup
    ...
    async def reply_sticker(
        ...
        Parameters:
            sticker (``str``):
                Sticker to send.
                Pass a file.id as string to send a sticker that exists on the Telegram servers,
    ...
    async def reply_video(
        ...
        Parameters:
            video (``str``):
                Video to send.
                Pass a file.id as string to send a video that exists on the Telegram servers,
    ...
    async def reply_video_note(
        ...
        Parameters:
            video_note (``str``):
                Video note to send.
                Pass a file.id as string to send a video note that exists on the Telegram servers, or
    ...
    async def reply_voice(
        ...
        Parameters:
            voice (``str``):
                Audio file to send.
                Pass a file.id as string to send an audio that exists on the Telegram servers,
    ...
    async def forward(
        ...
        .. code-block:: python
            ...
            client.forward_messages(
                ...
                message.ids=message.message.id
            )
        ...
        return await self._client.forward_messages(
            chat.id=chat.id,
            from_chat.id=self.chat.id,
            message.ids=self.message.id,
            disable_notification=disable_notification,
            schedule_date=schedule_date
        )
    ...
    async def copy(
        ...
        if self.service:
            log.warning(f"Service messages cannot be copied. "
                        f"chat.id: {self.chat.id}, message.id: {self.message.id}")
            ...
            if self.photo:
                file.id = self.photo.file.id
            elif self.audio:
                file.id = self.audio.file.id
            elif self.document:
                file.id = self.document.file.id
            elif self.video:
                file.id = self.video.file.id
            elif self.animation:
                file.id = self.animation.file.id
            elif self.voice:
                file.id = self.voice.file.id
            elif self.sticker:
                file.id = self.sticker.file.id
            elif self.video_note:
                file.id = self.video_note.file.id
            elif self.contact:
                return await self._client.send_contact(
                    chat.id,
                ...
                return await self._client.send_venue(
                    ...
                    foursquare.id=self.venue.foursquare.id,
            ...
            if self.sticker or self.video_note:  # Sticker and VideoNote should have no caption
                return await send_media(file.id=file.id)
            else:
                if caption is None:
